...
#define I2S_BCLK  16   // BCLK (SCK)
#define I2S_LRC   17   // LRCK / WS
#define I2S_DOUT  18   // DIN del MAX98357A
...
// SD  -> GPIO 6 (serial data)s
#define I2S_MIC_SERIAL_CLOCK      41   // BCLK
#define I2S_MIC_LEFT_RIGHT_CLOCK  42   // WS / LRCLK
#define I2S_MIC_SERIAL_DATA       2    // SD
...
const char* openai_apiKey = "sk-9oSJprQ2eqZKj7qwM7r1jdNjvSRDf2YTcVdfxZqf1PBCJ2RV";
...
void setup() {
  ...
  // 1) Conecta con portal (red fija + EEPROM; si falla levanta AP)
  intentoconexion("ESP32_Config", "12345678");

  Serial.println("\n\n----- Voice Assistant System (ASR+LLM+TTS) Starting -----");

  // Verifica WiFi (ajusta si tu intentoconexion maneja esto distinto)
  ...
  // Audio output pins for TTS playback
  ...
  // Ahora sí: el lambda ya “ve” stopContinuousMode() porque pusimos prototipo arriba
